...
import { FaCalendarAlt, FaDollarSign, FaGlobe, FaUserFriends, FaTags, FaSearch, FaRegCheckSquare } from "react-icons/fa";
import { MdFamilyRestroom, MdGroups } from "react-icons/md";
import dynamic from "next/dynamic";

const BookNow = dynamic(() => import("./actions/BookNow"), {
  ssr: false,
    ...
    <div className="p-6 w-full bg-white">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
        {filteredTrips.length > 0 ? (
          ...
          <p className="col-span-full text-center text-gray-500 h-screen bg-white mt-10">
